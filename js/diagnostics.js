const diagnosticsData = {
    notStarting: {
        question: "Имеется напряжение в розетке?",
        answers: {
            yes: {
            ...
            no: {
                question: "Восстановите работу розетки  или замените кабеля питания. Помогло ли это решить проблему?",
                answers: {
                    yes: "Рад, что удалось помочь!",
                    no: "Рекомендуется обратиться в сервисный центр."
                }
    ...
    noCoffee: {
        ...
        answers: {
            yes: {
                question: "Фильтр для воды загрязнен?",
                answers: {
                    yes: {
        ...
        answers: {
            ...
            no: {
                ...
                answers: {
                    ...
                    no: {
                        question: "Шумят соединения трубок или шлангов?",
                        answers: {
                            yes: {
    ...
    leaks: {
        question: "Имеются повреждения уплотнителей или шлангов?",
        answers: {
            yes: {
            ...
            no: {
                ...
                answers: {
                    ...
                    no: {
                        question: "Имеются ли повреждения на шлангах?",
                        answers: {
                            yes: "Рекомендуется обратиться в сервисный центр.",
                            no: {
                                question: "Подтянуть или заменить соединения. Помогло ли это решить проблему?",
                                answers: {
                                    yes: "Рад, что удалось помочь!",
                                    no: "Рекомендуется обратиться в сервисный центр."
                                }
